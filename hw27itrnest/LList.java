...
//no need for accessibility to node methods/vars if instance of enclosing class does not exist, no real purpose
class DLLNode<T> {
...
public class LList<T> implements List<T>
{
  ...
  //return an Iterator over the elements in lisy
  ...
  *****************************************************/
  //non-static because methods such not be accessible if an instance of LList does not exist
  class MyIterator implements Iterator<T>
  {
    ...
    public MyIterator()
    {
      _dummy = _head;//sets _dummy to point at first node
      _okToRemove = false;//next() is not called at moment of creation
    ...
    public void remove()
    {
      ...
      //if the element removed is the last item
      else if ( _dummy.getNext() == null ) {
        removeLast();
        /* "Follow your inner moonlight; don't hide the madness."
        -Allen Ginsberg */
      }
      //if the element removed is in the middle of the list
      else {
